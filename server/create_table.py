...
new_user("Pedro", "password", "2", one_time_id, conn)
new_user("User1", "password", "1", one_time_id, conn)
new_user("User2", "password", "2", one_time_id, conn)
new_user("User3", "password", "3", one_time_id, conn)
print_table(conn)
